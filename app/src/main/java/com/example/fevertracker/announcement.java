...
public class announcement extends AppCompatActivity {
            ...
            if (editpost) {
                ...
                reff.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        FirebaseDatabase.getInstance().getReference().child("adminInfo").child("announcement").child(Long.toString(announce.get(posToEdit).getId())).setValue(Html.toHtml(announcementE.getText()));
    ...
    public void saveAnn() {
        if (temp != -1) {
            FirebaseDatabase.getInstance().getReference().child("adminInfo").child("announcement").child(Long.toString(temp)).setValue(Html.toHtml(announcementE.getText()));
        } else {
            FirebaseDatabase.getInstance().getReference().child("adminInfo").child("announcement").child(Long.toString(max + 1)).setValue(Html.toHtml(announcementE.getText()));
        }
