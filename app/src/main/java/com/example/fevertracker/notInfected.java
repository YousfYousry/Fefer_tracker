...
public class notInfected extends AppCompatDialogFragment {
    ImageView imageView;
    String passWord = "";
    Window window;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        DatabaseReference reff = FirebaseDatabase.getInstance().getReference().child("adminInfo").child("QR").child("Not infected");
    ...
    public void generateQR() {
        if (window != null) {
            ...
            qrgEncoder.setColorBlack(Color.parseColor("#006633"));
