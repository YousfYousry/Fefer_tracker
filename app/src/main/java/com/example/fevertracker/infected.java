...
public class infected extends AppCompatDialogFragment {
    ImageView imageView;
    String passWord = "";
    Window window;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        DatabaseReference reff = FirebaseDatabase.getInstance().getReference().child("adminInfo").child("QR").child("Infected");
    ...
    public void generateQR() {
        if (window != null) {
            ...
            qrgEncoder.setColorBlack(Color.parseColor("#ff0000"));
